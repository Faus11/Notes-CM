...
class UpdateFragment : Fragment() {
    ...
    private  fun updateNote(){
        ...
        if(noteText.isEmpty() || noteText.length < 5) {
            ...
            makeText(requireContext(), R.string.edit_message, Toast.LENGTH_LONG).show()
            findNavController().navigate(R.id.action_updateFragment_to_listFragment)
        }
    }
    ...
    private fun deleteNote() {
        ...
        builder.setPositiveButton(R.string.yes_button) { _, _ ->
        ...
        builder.setNegativeButton(R.string.no_button) { _, _ -> }
        builder.setTitle(R.string.delete_button)
        builder.setMessage(R.string.del_txt)
        builder.create().show()
    }
}